...
def main():
    ...
    #data.columns=["주소","충전기타입(1:완속,2:급속)","충전기명칭","충전소ID","csNm"]
    data[li].to_csv('./%s_전기차충전소.csv' % (addr) ,index=False, encoding='cp949',mode="w")
    ...
    ax = city_df.plot(kind='bar', title='충전소', figsize=(12,9), legend=True, fontsize=7)
